...
const aboutPageContent: Content = {
  titel: "About me",
  pageDescription:
    "Hello! I’m Marko, a passionate and versatile software developer with a love for all things code. My journey into programming started with a curiosity about how technology shapes our daily lives, and over the years, that curiosity has evolved into a career focused on creating powerful, seamless digital experiences. ",
